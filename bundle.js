...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var require_load_script2 = __commonJS({
    "../node_modules/load-script2/index.js"(exports, module) {
      module.exports = load;
  ...
  function loadSdk() {
    return new Promise(function(resolve, reject) {
      ...
      (0, import_load_script2.default)("https://www.youtube.com/iframe_api", function(err) {
        if (err) {
          reject(err);
        } else {
          window.YT.ready(function() {
  ...
  var YouTube = /* @__PURE__ */ function(_React$Component) {
    _inheritsLoose(YouTube2, _React$Component);
    ...
    _proto.onPlayerStateChange = function onPlayerStateChange(event) {
      var _this$props2 = this.props, onCued2 = _this$props2.onCued, onBuffering2 = _this$props2.onBuffering, onPause2 = _this$props2.onPause, onPlaying2 = _this$props2.onPlaying, onEnd2 = _this$props2.onEnd;
    ...
    _proto.createPlayer = function createPlayer() {
      ...
      this.player = getSdk().then(function(YT2) {
        return new Promise(function(resolve) {
          _this4.resolvePlayer = resolve;
          var player = new YT2.Player(_this4.container, _this4.getInitialOptions());
  ...
  if (true) {
    YouTube.propTypes = {
      video: import_prop_types.default.string,
      ...
      showCaptions: import_prop_types.default.bool,
      controls: import_prop_types.default.bool,
      disableKeyboard: import_prop_types.default.bool,
      allowFullscreen: import_prop_types.default.bool,
      lang: import_prop_types.default.string,
      annotations: import_prop_types.default.bool,
      startSeconds: import_prop_types.default.number,
      endSeconds: import_prop_types.default.number,
      ...
      onCued: import_prop_types.default.func,
      onBuffering: import_prop_types.default.func,
  ...
  function App() {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", {
      ...
      className: "col s4"
    }, /* @__PURE__ */ import_react.default.createElement("h5", null, "Video"), /* @__PURE__ */ import_react.default.createElement("div", {
      className: "collection"
    }, videos.map((choice, index) => /* @__PURE__ */ import_react.default.createElement("a", {
      key: choice.id,
      href: `#!/video/${index}`,
      className: `collection-item ${video === choice ? "active" : ""}`,
      onClick: () => selectVideo(index)
    }, choice.name))), /* @__PURE__ */ import_react.default.createElement("h5", null, "Paused"), /* @__PURE__ */ import_react.default.createElement("p", null, /* @__PURE__ */ import_react.default.createElement("label", {
      htmlFor: "paused"
    ...
    }), /* @__PURE__ */ import_react.default.createElement("span", null, "Paused"))), /* @__PURE__ */ import_react.default.createElement("h5", null, "Volume"), /* @__PURE__ */ import_react.default.createElement("input", {
      type: "range",
      value: volume,
      min: 0,
      max: 1,
    ...
    }), /* @__PURE__ */ import_react.default.createElement("h5", null, "Quality"), /* @__PURE__ */ import_react.default.createElement("select", {
      className: "browser-default",
      onChange: handleQuality
    }, qualities.map((quality) => /* @__PURE__ */ import_react.default.createElement("option", {
      key: quality,
      value: quality
    }, quality)))), /* @__PURE__ */ import_react.default.createElement("div", {
      className: "col s8 center-align"
    }, /* @__PURE__ */ import_react.default.createElement(YouTube, {
      video: video.id,
      width: 640,
      height: 480,
      autoplay: true,
  ...
  import_react_dom.default.render(/* @__PURE__ */ import_react.default.createElement(App, null), document.getElementById("example"));
})();
/*
object-assign
(c) Sindre Sorhus
